...
- Autocomplete
  - [ ] Shows suggestion during typing
- Chat
  - [ ] [Chat View](#chat-view)
  - [ ] [Context](#context)
...
Autocomplete is supported and should show suggestion as grey text when typing. Use `Tab` to accept a suggestion. Works from Visual Studio version 17.6+
